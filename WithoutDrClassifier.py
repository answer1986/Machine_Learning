...
data = pd.read_excel('Datasets/Gear25.xlsx')
...
grid_search1 = GridSearchCV(estimator = classifier_knn, param_grid=param_grid_knn, cv = 2, n_jobs = -1, verbose = 2)
...
grid_search3 = GridSearchCV(estimator = RBFClassifier, param_grid=param_grid_rbf, cv = 2, n_jobs = -1, verbose = 2)
